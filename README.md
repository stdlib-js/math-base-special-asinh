...
```javascript
asinh = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-asinh@v0.2.4-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-asinh/actions/workflows/test.yml/badge.svg?branch=v0.2.4
[test-url]: https://github.com/stdlib-js/math-base-special-asinh/actions/workflows/test.yml?query=branch:v0.2.4
