...
tape( 'the function computes the hyperbolic arcsine on the interval `[-1e-308,-1e-300]`', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function computes the hyperbolic arcsine on the interval `[1e-300,1e-308]`', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function computes the hyperbolic arcsine on the interval `[-1e200,-1e208]`', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function computes the hyperbolic arcsine on the interval `[1e300,1e308]`', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
